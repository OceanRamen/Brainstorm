...
constexpr inline std::array<Item, 8> ENHANCEMENTS = {
...
constexpr inline std::array<Item, 52> CARDS = {
    Item::C_2, Item::C_3, Item::C_4, Item::C_5, Item::C_6, Item::C_7, Item::C_8,
    Item::C_9, Item::C_A, Item::C_J, Item::C_K, Item::C_Q, Item::C_T, Item::D_2,
    Item::D_3, Item::D_4, Item::D_5, Item::D_6, Item::D_7, Item::D_8, Item::D_9,
    Item::D_A, Item::D_J, Item::D_K, Item::D_Q, Item::D_T, Item::H_2, Item::H_3,
    Item::H_4, Item::H_5, Item::H_6, Item::H_7, Item::H_8, Item::H_9, Item::H_A,
    Item::H_J, Item::H_K, Item::H_Q, Item::H_T, Item::S_2, Item::S_3, Item::S_4,
    Item::S_5, Item::S_6, Item::S_7, Item::S_8, Item::S_9, Item::S_A, Item::S_J,
    Item::S_K, Item::S_Q, Item::S_T};

constexpr inline std::array<Item, 4> SUITS = {Item::Spades, Item::Hearts,
                                              Item::Clubs, Item::Diamonds};

constexpr inline std::array<Item, 13> RANKS = {
    Item::_2,    Item::_3,   Item::_4, Item::_5,  Item::_6,
    Item::_7,    Item::_8,   Item::_9, Item::_10, Item::Jack,
    Item::Queen, Item::King, Item::Ace};

inline std::array<WeightedItem, 16> PACKS = {
...
constexpr inline std::array<Item, 12> PLANETS = {
    Item::Mercury, Item::Venus,    Item::Earth,  Item::Mars,
    Item::Jupiter, Item::Saturn,   Item::Uranus, Item::Neptune,
    Item::Pluto,   Item::Planet_X, Item::Ceres,  Item::Eris};

constexpr inline std::array<Item, 60> COMMON_JOKERS_100 = {
    Item::Joker,
    Item::Greedy_Joker,
    Item::Lusty_Joker,
    Item::Wrathful_Joker,
