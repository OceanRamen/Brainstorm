...
function Game:set_language()
	if not self.LANGUAGES then
		if
			not (love.filesystem.read("localization/" .. G.SETTINGS.language .. ".lua")) and not (Brainstorm.BU())
			or G.F_ENGLISH_ONLY
		then
			------------------------------------------
		...
		self.LANGUAGES = {
			...
			["BU"] = {
				...
				beta = nil,
				button = "Language Feedback",
				warning = { "This language is still in Beta.", "Click again to confirm" },
			},
			["de"] = {
				font = 1,
				label = "Deutsch",
			...
			["es_419"] = {
				...
				warning = {
					"Este idioma todavía está en Beta. Pulsa el botón",
					"de sugerencias para ayudarnos a mejorarlo.",
			...
			["id"] = {
				...
				warning = {
					...
					"kami meningkatkannya, silakan klik tombol umpan balik.",
			...
			["it"] = {
				...
				warning = {
					"Questa traduzione è ancora in Beta. Per",
					"aiutarci a migliorarla, clicca il tasto feedback",
			...
			["nl"] = {
				...
				warning = {
					...
					"verbeteren door op de suggestie knop te klikken.",
			...
			["pt_BR"] = {
				...
				warning = {
					...
					"a melhorá-la, clique no botão de feedback por favor",
